...
<body>
    ...
    <div class="container px-5 my-3">
        <h2 class="text-center">Formulario de Ingreso de Horario</h2>
        <div class="row">
                    ...
                    <div class="card rounded-0 shadow">
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <?php else : ?>
                                    <p class="text-muted"><i>Agregar Nuevo Horario</b></i></p>
                                <?php endif; ?>
                                <form id="member-form" action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-0" id="hasta" name="hasta" required="required" value="<?= isset($data->desde) ? $data->desde : '' ?>">
                                    </div>
                                </form>
                            </div>
                        </div>
